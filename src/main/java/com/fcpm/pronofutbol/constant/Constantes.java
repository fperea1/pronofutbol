...
public final class Constantes {
	...
	public static final String TIPOS_SORTEO = "/tipos-sorteos";
	...
	public static final String VALIDATION_NOMBRE_EQUIPO_SIZE = "validation.nombre.equipo.size";
	...
	public static final String VALIDATION_PUNTOS_OBLIGATORIO = "validation.puntos.obligatorio";

	public static final String VALIDATION_EMPATADOS_LOCAL_OBLIGATORIO = "validation.empatados.local.obligatorio";

	public static final String VALIDATION_PERDIDOS_LOCAL_OBLIGATORIO = "validation.perdidos.local.obligatorio";

	public static final String VALIDATION_EMPATADOS_VISITANTE_OBLIGATORIO = "validation.empatados.visitante.obligatorio";

	public static final String VALIDATION_PERDIDOS_VISITANTE_OBLIGATORIO = "validation.perdidos.visitante.obligatorio";
