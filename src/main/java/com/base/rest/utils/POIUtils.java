...
public final class POIUtils {
	...
	public static byte[] getReportExcel(List<BaseDTO> listado, Enum[] tablaEnum, String titulo) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, IOException {
