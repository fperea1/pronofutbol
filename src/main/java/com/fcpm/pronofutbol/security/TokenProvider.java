...
import static com.fcpm.pronofutbol.security.ConstantesToken.*;
...
public class TokenProvider implements Serializable {
    ...
    private static final long serialVersionUID = 5667561227547297244L;
    ...
    public String generateToken(Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .claim(HEADER_AUTHORIZACION_KEY, authorities)
    ...
    UsernamePasswordAuthenticationToken getAuthentication(final String token, final UserDetails userDetails) {
        ...
        final Collection<? extends GrantedAuthority> authorities =
                Arrays.stream(claims.get(HEADER_AUTHORIZACION_KEY).toString().split(","))
